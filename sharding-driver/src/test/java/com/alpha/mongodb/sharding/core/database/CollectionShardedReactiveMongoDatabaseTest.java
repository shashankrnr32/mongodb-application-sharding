...
public class CollectionShardedReactiveMongoDatabaseTest {
    ...
    public void testNestedGetters() {
        assertTrue(getFixture().withCodecRegistry(mock(CodecRegistry.class))
                instanceof CollectionShardedReactiveMongoDatabase);
    ...
    public void testDelegatedMethods() {
        CollectionShardedReactiveMongoDatabase fixture = getFixture();
    ...
    public CollectionShardedReactiveMongoDatabase getFixture() {
        return new CollectionShardedReactiveMongoDatabase(delegatedMongoDatabase, collectionShardingOptions);
    }
